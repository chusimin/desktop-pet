...
> 🐾 **想自己做一只？** 全程由产品指挥、AI 编写。我把它抽象成了一份换皮通用的分层手册 + 真实提示词：[**《从零 vibe 出一只桌面宠物 · 全流程手册》**](docs/桌宠复现手册.md)——**基础操作**人人都能做出一只活宠物，**进阶模块**（眼神 / 对话 / 语音 / 唤醒 / 起终端）自己挑着加，**自由探索**再加点小花样。做到哪一步，它都是你的。
